...
const SignUp = () => {
 ...
 if (page>0) {
  ...
  return (
    <div
      className="bg-black h-screen w-screen text-white flex justify-center items-center 
    "
    >
        ...
        {page == 1 && (
          <>
            ...
            <input
              ...
              required
            />
            <button className="bg-orange-400 w-25 p-2 rounded-4xl ml-45 mt-4 cursor-pointer hover:bg-amber-700" onClick={handelNext}>
              Next
            </button>
          </>
        )}
        {page == 2 && (
          ...
          <div className="flex items-center gap-2 bg-gray-600 p-2 rounded-4xl">
            ...
            <input
             type={showpass?"text":"password"}
              ...
              required
            />
            <div onChange={()=>setshowpass(!showpass)}>
              <input type="checkbox" name="showpass" id="showpass" required />
              <label htmlFor="showpass" className="text-gray-100 ml-2 font-bold">Show Password</label>
            </div>
            <button className="bg-orange-400 w-25 p-2 rounded-4xl ml-45 mt-4 cursor-pointer hover:bg-amber-700" onClick={handelNext}>
              Next
            </button>
         ...
         {page == 3 && (
          ...
          <div className="flex  items-center gap-1">
           <div>
             {
              fontImage?<img src={fontImage} alt="profileimage" required />:<CgProfile  className="h-22 w-22"/>
             }
           </div>
           <div className="flex flex-col w-58 p-2 gap-2">
            <b>Choose Profile Picture</b>
            <input type="file"  className="bg-orange-400 p-2 rounded-2xl" onChange={handelar}/>
           </div>
          </div>
